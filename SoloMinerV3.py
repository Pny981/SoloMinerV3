...
address = 'bc1qtfequtm6du2cul6mcl3rk0k00sta0wa000ufalxr2tre0f7hteaqj0uk66' 
...
def bitcoin_miner(t , restarted = False) :
    if restarted :
        ...
        print(Fore.MAGENTA , '[' , timer() , ']' , Fore.YELLOW , 'Programmer = Crypto_ixer')
...
def StartMining() :
    ...
    print(Fore.BLUE , '--------------~~( ' , Fore.YELLOW , ' Crypto_ixer ' , Fore.BLUE , ' )~~--------------')
